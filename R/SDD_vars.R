#' Generate SFD and SDD variables 
#'
#' Transforms variables by taking spatial first difference (SFD) and spatial double differences (SDD). Please see: Druckenmiller & Hsiang (2018).
...
SDD_vars <- function(spatial_df, n_channel,
  ...
  sample <- sample[ , -which(names(sample) %in% c("order","cent.long","cent.lat", "layer", "row", "d.layer", "dd.row"))]
  return(sample)
}
